var botonEncriptar = document.querySelector(".b_encriptar");
var botonDesencriptar = document.querySelector(".b_desencriptar");
var munieco = document.querySelector(".area_desencriptar");
